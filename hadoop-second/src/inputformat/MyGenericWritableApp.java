...
//	private static final String INPUT_PATH = "hdfs://master.hadoop:9000/files";
	private static final String OUT_PATH = "hdfs://master.hadoop:9000/out";
	...
	public static void main(String[] args) throws Exception{
		...
		MultipleInputs.addInputPath(job, new Path("hdfs://master.hadoop:9000/files/hello"), KeyValueTextInputFormat.class, MyMapper.class);
		MultipleInputs.addInputPath(job, new Path("hdfs://master.hadoop:9000/files/hello2"), TextInputFormat.class, MyMapper2.class);
