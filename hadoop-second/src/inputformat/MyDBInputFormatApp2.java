...
public class MyDBInputFormatApp2 {
	...
	public static void main(String[] args) throws Exception{
		...
		DistributedCache.addArchiveToClassPath(new Path("hdfs://master.hadoop:9000/tmp/mysql-connector-java-5.1.10.jar"), job);
		...
		DBConfiguration.configureDB(job, "com.mysql.jdbc.Driver", "jdbc:mysql://master.hadoop:3306/test", "root", "root123");
